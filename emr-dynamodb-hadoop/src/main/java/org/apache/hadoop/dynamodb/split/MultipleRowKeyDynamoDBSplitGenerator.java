...
public class MultipleRowKeyDynamoDBSplitGenerator extends DynamoDBSplitGenerator {
  ...
  public MultipleRowKeyDynamoDBSplitGenerator(JobConf jobConf) {
    indexName = getRequiredValue(jobConf, DynamoDBConstants.INDEX_NAME);
    rowKeyName = getRequiredValue(jobConf, DynamoDBConstants.ROW_KEY_NAME);
    sortKeyName = getRequiredValue(jobConf, DynamoDBConstants.SORT_KEY_NAME);
